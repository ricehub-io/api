...
func init() {
	config.Config.App.CDNUrl = "https://cdn.example.com"
	config.Config.App.DefaultAvatar = "/default.png"
}
...
func TestGetUserAvatar_EmptyCDNUrl(t *testing.T) {
	...
	config.Config.App.CDNUrl = ""

	got := getUserAvatar(nil)
	if got != "/default.png" {
		t.Errorf("want %q, got %q", "/default.png", got)
	}
}
...
func TestGetUserAvatar_ProvidedPathIgnoresDefault(t *testing.T) {
	...
	if got == "https://cdn.example.com/default.png" {
