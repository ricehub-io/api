...
func run() error {
	...
	riceScreenshotService := services.NewRiceScreenshotService(dbPool, riceRepo, userRepo, userBanRepo)
	...
	riceService := services.NewRiceService(dbPool, riceRepo, riceDotfilesRepo, riceTagRepo, commentRepo, userRepo, userBanRepo)
